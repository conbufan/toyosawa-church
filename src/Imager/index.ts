...
export class Imager {
    ...
    //
    //
    static init( element: HTMLImageElement ){
    ...
    */
    loadedAll( onComplete: ( element: HTMLImageElement, count: number, max: number )=>void ){
        const image$element: WeakMap<HTMLImageElement,HTMLImageElement> = new WeakMap();
        ...
        for ( let element of array ){
            ...
            promises.push(
                new Promise( (resolve, reject)=>{
                    image.onload = ((element: HTMLImageElement)=>{
                        count++;
